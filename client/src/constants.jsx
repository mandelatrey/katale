...
export const commodities = [
  ...
  { key: "groundnuts", label: "G.Nuts", icon: <Nut size={16} className="text-green-700" /> },
  { key: "cassava", label: "Cassava", icon: <TreeDeciduous size={16} className="text-green-700" /> },
  { key: "sweet_potatoes", label: "S.Potato", icon: <LeafyGreen size={16} className="text-green-700" /> },
